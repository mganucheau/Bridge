...
// ─────────────────────────────────────────────────────────────────────────────
// Material Design 3 — dark colour scheme, amber/gold primary for Stevie
...
// ─── Legacy alias tokens ─────────────────────────────────────────────────────
namespace StevieColors
{
    inline const juce::Colour& Background  = StevieM3::surface;
    inline const juce::Colour& Panel       = StevieM3::surfaceContainer;
    inline const juce::Colour& Border      = StevieM3::outlineVariant;
    inline const juce::Colour& Accent      = StevieM3::primary;
    inline const juce::Colour& AccentBright= StevieM3::onPrimaryContainer;
    inline const juce::Colour& TextPrimary = StevieM3::onSurface;
    inline const juce::Colour& TextDim     = StevieM3::onSurfaceVariant;
    inline const juce::Colour& ActiveStep  = StevieM3::primary;
...
// ─────────────────────────────────────────────────────────────────────────────
class StevieLookAndFeel : public juce::LookAndFeel_V4
{
public:
    StevieLookAndFeel()
    {
