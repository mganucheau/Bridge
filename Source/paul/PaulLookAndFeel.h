...
// ─────────────────────────────────────────────────────────────────────────────
// Material Design 3 — dark colour scheme, amber/gold primary for Paul
...
// ─── Legacy alias tokens ─────────────────────────────────────────────────────
namespace PaulColors
{
    inline const juce::Colour& Background  = PaulM3::surface;
    inline const juce::Colour& Panel       = PaulM3::surfaceContainer;
    inline const juce::Colour& Border      = PaulM3::outlineVariant;
    inline const juce::Colour& Accent      = PaulM3::primary;
    inline const juce::Colour& AccentBright= PaulM3::onPrimaryContainer;
    inline const juce::Colour& TextPrimary = PaulM3::onSurface;
    inline const juce::Colour& TextDim     = PaulM3::onSurfaceVariant;
    inline const juce::Colour& ActiveStep  = PaulM3::primary;
...
// ─────────────────────────────────────────────────────────────────────────────
class PaulLookAndFeel : public juce::LookAndFeel_V4
{
public:
    PaulLookAndFeel()
    {
