...
using PianoPattern = std::array<PianoHit, PianoPreset::NUM_STEPS>;
...
public:
    ...
    // ── Parameters ─────────────────────────────────────────────────────────
    void setStyle       (int  s) { style       = jlimit (0, PianoPreset::NUM_STYLES - 1, s); }
    void setScale       (int  s) { scale       = jlimit (0, PianoPreset::NUM_SCALES - 1, s); }
    ...
    void setPatternLen  (int   l){ patternLen  = jlimit (1, PianoPreset::NUM_STEPS, l); }
...
private:
    ...
    int   patternLen  = PianoPreset::NUM_STEPS;
    bool  locked      = false;
    uint32 seed       = 42;
    int   barCount    = 0;
    int   phraseBars  = 4;
