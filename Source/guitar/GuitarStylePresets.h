...
// ─────────────────────────────────────────────────────────────────────────────
// Bass — Generative Funk Bass  ·  Style presets & scale data
//
...
static const char* STYLE_NAMES[NUM_STYLES] = {
    "Fingerpick", "Funk", "Rock", "Blues",
    "Country", "Jazz", "Ambient", "Strum"
};
...
// ─── 0: FUNK (Bass Collins / James Brown style) ─────────────────────────────
...
// ─── 5: R&B (Marvin Gaye / Piano Wonder style) ───────────────────────────────
