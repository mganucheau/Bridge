...
// ─────────────────────────────────────────────────────────────────────────────
// Material Design 3 — dark colour scheme, amber/gold primary for Guitar
...
{
    inline const juce::Colour& Background  = GuitarM3::surface;
    inline const juce::Colour& Panel       = GuitarM3::surfaceContainer;
    inline const juce::Colour& Border      = GuitarM3::outlineVariant;
    inline const juce::Colour& Accent      = GuitarM3::primary;
    inline const juce::Colour& AccentBright= GuitarM3::onPrimaryContainer;
    inline const juce::Colour& TextPrimary = GuitarM3::onSurface;
    inline const juce::Colour& TextDim     = GuitarM3::onSurfaceVariant;
    inline const juce::Colour& ActiveStep  = GuitarM3::primary;
