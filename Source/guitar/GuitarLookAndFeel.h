...
namespace GuitarHIG
{
    ...
    inline juce::Colour primary()               { return bridge::colors::accentGuitar(); }
    inline const juce::Colour& onPrimary        = bridge::hig::label;
    inline juce::Colour primaryContainer()     { return bridge::hig::accentFillSubdued (bridge::colors::accentGuitar()); }
    inline const juce::Colour& onPrimaryContainer = bridge::hig::label;

    inline juce::Colour secondaryContainer()
    {
        return bridge::hig::tertiaryGroupedBackground.interpolatedWith (bridge::colors::accentGuitar(), 0.32f);
    }
    inline const juce::Colour& onSecondaryContainer = bridge::hig::label;

    inline juce::Colour tertiary()               { return bridge::colors::accentGuitar(); }
    inline juce::Colour tertiaryContainer()      { return bridge::hig::accentFillSubdued (bridge::colors::accentGuitar()); }
...
// ─── Legacy alias tokens ─────────────────────────────────────────────────────
namespace GuitarColors
{
    inline const juce::Colour& Background  = GuitarHIG::surface;
    inline const juce::Colour& Panel       = GuitarHIG::surfaceContainer;
    inline const juce::Colour& Border      = GuitarHIG::outlineVariant;
    inline juce::Colour Accent() { return GuitarHIG::primary(); }
    inline const juce::Colour& AccentBright= GuitarHIG::onPrimaryContainer;
    inline const juce::Colour& TextPrimary = GuitarHIG::onSurface;
    inline const juce::Colour& TextDim     = GuitarHIG::onSurfaceVariant;
    inline juce::Colour ActiveStep() { return GuitarHIG::primary(); }
