      ...
      knobLoopEnd   ("loopEnd",   "End",   p.apvtsPaul)
{
    ...
    auto setupSectionLabel = [] (juce::Label& lab, const juce::String& text)
    {
        ...
        lab.setColour (juce::Label::textColourId, PaulColors::TextDim);
    ...
    loopWidthLockButton.setColour (juce::TextButton::buttonOnColourId, PaulM3::primary.withAlpha (0.45f));
    loopWidthLockButton.setColour (juce::TextButton::textColourOffId, PaulColors::TextDim);
...
namespace
{
    void layoutPaulDropdownRow (juce::Rectangle<int> row,
...
void PaulPanel::resized()
{
    ...
    layoutPaulDropdownRow (dropdownArea,
