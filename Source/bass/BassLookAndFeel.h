...
// Apple HIG–aligned surfaces + Bass accent (see BridgeAppleHIG.h).
namespace BassHIG
{
    ...
    inline juce::Colour primary()               { return bridge::colors::accentBass(); }
    inline const juce::Colour& onPrimary        = bridge::hig::label;
    inline juce::Colour primaryContainer()     { return bridge::hig::accentFillSubdued (bridge::colors::accentBass()); }
    inline const juce::Colour& onPrimaryContainer = bridge::hig::label;

    inline juce::Colour secondaryContainer()
    {
        return bridge::hig::tertiaryGroupedBackground.interpolatedWith (bridge::colors::accentBass(), 0.32f);
    }
    inline const juce::Colour& onSecondaryContainer = bridge::hig::label;

    inline juce::Colour tertiary()               { return bridge::colors::accentBass(); }
    inline juce::Colour tertiaryContainer()      { return bridge::hig::accentFillSubdued (bridge::colors::accentBass()); }
...
{
    inline const juce::Colour& Background  = BassHIG::surface;
    inline const juce::Colour& Panel       = BassHIG::surfaceContainer;
    inline const juce::Colour& Border      = BassHIG::outlineVariant;
    inline juce::Colour Accent() { return BassHIG::primary(); }
    inline const juce::Colour& AccentBright= BassHIG::onPrimaryContainer;
    inline const juce::Colour& TextPrimary = BassHIG::onSurface;
    inline const juce::Colour& TextDim     = BassHIG::onSurfaceVariant;
    inline juce::Colour ActiveStep() { return BassHIG::primary(); }
