...
// ─────────────────────────────────────────────────────────────────────────────
// Material Design 3 — dark colour scheme, amber/gold primary for Bootsy
...
// ─── Legacy alias tokens ─────────────────────────────────────────────────────
namespace BootsyColors
{
    inline const juce::Colour& Background  = BootsyM3::surface;
    inline const juce::Colour& Panel       = BootsyM3::surfaceContainer;
    inline const juce::Colour& Border      = BootsyM3::outlineVariant;
    inline const juce::Colour& Accent      = BootsyM3::primary;
    inline const juce::Colour& AccentBright= BootsyM3::onPrimaryContainer;
    inline const juce::Colour& TextPrimary = BootsyM3::onSurface;
    inline const juce::Colour& TextDim     = BootsyM3::onSurfaceVariant;
    inline const juce::Colour& ActiveStep  = BootsyM3::primary;
...
// ─────────────────────────────────────────────────────────────────────────────
class BootsyLookAndFeel : public juce::LookAndFeel_V4
{
public:
    BootsyLookAndFeel()
    {
